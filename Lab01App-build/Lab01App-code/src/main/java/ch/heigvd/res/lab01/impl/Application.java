...
public class Application implements IApplication {
    ...
    /*
     *@brief : Fetch and store quotes from a server to a list of subdirectories
     */
    @Override
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        //generate path with tags
        String subPath = WORKSPACE_DIRECTORY;
        for (String tag : quote.getTags()) {
            subPath += "/" + tag;
        }

        File fileStructure = new File(subPath);
        if (!fileStructure.mkdirs())
            System.err.print("Error during folder creation");
    ...
    /*
     *@brief : return email of author
     */
    @Override
    public String getAuthorEmail() {
        return "samuel.mayor@heig-vd.ch";
    }
