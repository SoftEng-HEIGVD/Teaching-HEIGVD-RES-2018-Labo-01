...
public class Application implements IApplication {
    ...
    public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
        ...
        for (int i = 0; i < numberOfQuotes; i++) {
            ...
            storeQuote(quote, "quote-" + (counter++) + ".utf8");
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        StringBuilder builder   = new StringBuilder(WORKSPACE_DIRECTORY + File.separator);

        for(String tag : quote.getTags())
            builder.append(tag).append(File.separator);

        File quoteDirectory = new File(builder.toString());

        quoteDirectory.mkdirs();
        builder.append(filename);

        Writer writer = new OutputStreamWriter(new FileOutputStream(new File(builder.toString())), "utf8");
    ...
    public String getAuthorEmail() {
        return "guillaume.hochet@heig-vd.ch";
    }
