...
public class Application implements IApplication {
    ...
    public static String AUTHOR_EMAIL = "adam.zouari@heig-vd.ch";
    ...
    public void fetchAndStoreQuotes(int numberOfQuotes) throws IOException {
        ...
        for (int i = 0; i < numberOfQuotes; i++) {
            ...
            // store the content of the quote in a text file
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        // workspace doesn't exist beacause he's deleted in the main by clearOutputDirectory 
        workspace.mkdirs();
        
        // if the quote have tags
        if (!quote.getTags().isEmpty()) 
        {
            // create sub-folders path
