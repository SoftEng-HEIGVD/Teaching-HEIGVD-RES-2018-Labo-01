...
public class Application implements IApplication {
    ...
    void storeQuote(Quote quote, String filename) throws IOException {
        ...
        String finalPath = subPath;
        try {
            File p = new File(finalPath);
            p.mkdirs();
        } catch (Exception e) {
            System.out.println("Failed to create directories for PATH: " + finalPath);
        }
        finalPath += "/quote-" + quote.getValue().getId() + ".utf8";
    ...
    public String getAuthorEmail() {
        return "guillaume.zaretti@heig-vd.ch";
    }
