...
public abstract class FileTransformer implements IFileVisitor {
    ...
    public void visit(File file) {
        ...
        try {
            ...
            /* --- More suitable solution but it cause an akward error in CompleteFileTransformerTest.java -------------
            ...
            //read the characters from the reader and write them to the writer.
            int c;
